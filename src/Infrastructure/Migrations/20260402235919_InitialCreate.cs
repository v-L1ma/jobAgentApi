    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    PlataformJobId = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NormalizedHash = table.Column<string>(type: "text", nullable: false),
                    Active = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    LastModifiedBy = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserSearchQueries", x => new { x.UserId, x.SearchQueryId });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Questions_JobApplications_JobApplicationId",
                        column: x => x.JobApplicationId,
                        principalTable: "JobApplications",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Questions_JobApplications_JobApplicationId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobAnalysis_Jobs_JobId",
                        column: x => x.JobId,
                        principalTable: "Jobs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlataformConfigurations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PlataformConfigurations_Plataforms_PlataformId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobAnalysis_JobId",
                table: "JobAnalysis",
                column: "JobId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PlataformConfigurations_PlataformId",
                table: "PlataformConfigurations",
                column: "PlataformId");

            migrationBuilder.CreateIndex(
                name: "IX_Questions_JobApplicationId",
                table: "Questions",
                column: "JobApplicationId");

            migrationBuilder.CreateIndex(
                name: "IX_Questions_JobApplicationId1",
                table: "Questions",
                column: "JobApplicationId1");

            migrationBuilder.CreateIndex(
                name: "IX_SearchQueries_NormalizedHash",
                table: "SearchQueries",
                column: "NormalizedHash");
        }
