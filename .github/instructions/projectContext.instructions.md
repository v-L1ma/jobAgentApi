---
description: Descrição geral do projeto, arquitetura, módulos e stack tecnológica para o Job Agent API - Centralizador de Vagas & CV Inteligente.
applyTo: 'all' 
---
...
- **Padrões Arquiteturais**: Clean Architecture, CQRS, Repository & Unit of Work, MediatR, Result pattern
